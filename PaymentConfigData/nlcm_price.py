...
link = './data/item-info/NLCM-item-info.json'
link2 = './data/payment-method/NLCM-payment-method.json'
...
writer = open("nlcm_product_payment_methods.json", "w")

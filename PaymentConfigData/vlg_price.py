...
link2 = './data/payment-method/VLG-payment-method.json'
...
writer = open("vlg_product_payment_methods.json", "w")

writer.write(str(data).replace('\'', '\"').replace('True', 'true').replace("False", 'false'))
